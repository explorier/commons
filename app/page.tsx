        ...
        <div className="max-w-6xl mx-auto px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-zinc-900">Commons</h1>
                <p className="hidden sm:block text-xs text-zinc-500">Community radio for all</p>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                href="/contact"
                className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-teal-50 to-emerald-50 text-teal-700 text-sm font-medium rounded-full hover:from-teal-100 hover:to-emerald-100 transition-all border border-teal-200/50"
              >
