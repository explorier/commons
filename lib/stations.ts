...
const stationInputs: StationInput[] = [
  ...
  // New batch: 7 terrestrial community + 3 web-only
  {
    callSign: "WCXP-LP",
    name: "CHIRP Radio",
    frequency: "107.1 FM",
    location: "Chicago, IL",
    description: "Volunteer-driven community radio. Independent music and arts.",
    streamUrl: "https://peridot.streamguys1.com:5185/live",
    website: "https://chirpradio.org",
    coordinates: { lat: 41.9537, lng: -87.6756 },
    disableNowPlaying: true,
  },
  {
    callSign: "WOWD-LP",
    ...
    description: "Locally-produced freeform programming for DC metro area.",
    streamUrl: "https://wowd.broadcasttool.stream/stream",
    website: "https://takomaradio.org",
  ...
  },
  {
    ...
    description: "Mountain community radio.",
    streamUrl: "https://aurora.shoutca.st/radio/8200/radio.mp3",
    website: "https://wmmt.org",
    coordinates: { lat: 37.1184, lng: -82.8268 },
  },
  {
    callSign: "KCHUNG",
    frequency: "1630 AM",
    location: "Los Angeles, CA",
    description: "Artist-run radio from Chinatown. Experimental and freeform.",
    streamUrl: "https://kchungradio.out.airtime.pro/kchungradio_a",
    website: "https://www.kchungradio.org",
    coordinates: { lat: 34.0622, lng: -118.2373 },
    channels: [
      {
        id: "kchung-chinatown",
        name: "Chinatown",
        streamUrl: "https://kchungradio.out.airtime.pro/kchungradio_a",
        description: "Main studio in Chinatown.",
      },
      {
        id: "kchung-moca",
        name: "MOCA",
        streamUrl: "https://kchungradio.out.airtime.pro/kchungradio_b",
        description: "KCHUNG PUBLIC at MOCA Geffen.",
      },
    ],
  },
  {
    ...
    description: "All-volunteer since 1972. Eclectic community radio.",
    streamUrl: "https://kkup.streamguys1.com/live",
    website: "https://kkupfm.org",
  ...
  },
  {
    ...
    description: "Community radio with global soul. Diverse music and talk.",
    streamUrl: "https://listen.wruu.org/stream",
    website: "https://www.wruu.org",
  ...
  },
  {
    ...
    description: "Community radio serving Northern Colorado since 2005.",
    streamUrl: "https://ice24.securenetsystems.net/KRFCFM",
    website: "https://krfcfm.org",
    coordinates: { lat: 40.5853, lng: -105.0844 },
  },
  // Web-only community stations
  {
    callSign: "8BALL",
    name: "8 Ball Radio",
    frequency: "WEB",
    location: "New York, NY",
    description: "Volunteer-run freeform from Brooklyn.",
    streamUrl: "https://eightball.out.airtime.pro/eightball_a",
    website: "https://8ballradio.nyc",
  ...
  },
  {
    ...
    frequency: "WEB",
    location: "Brooklyn, NY",
    description: "DIY Brooklyn radio. Freeform from an RV turned studio.",
    streamUrl: "https://das-edge14-live365-dal02.cdnstream.com/a18444",
    website: "https://kpiss.fm",
    coordinates: { lat: 40.7081, lng: -73.9271 },
  },
  {
    callSign: "BFF",
    name: "BFF.fm",
    frequency: "WEB",
    location: "San Francisco, CA",
    description: "Bay Area community internet radio. Underground and emerging artists.",
  ...
  },
  {
    ...
    frequency: "106.5 FM",
    location: "Louisville, KY",
    description: "Grassroots community radio for social justice.",
  ...
  },
  {
    ...
    frequency: "107.1 FM",
    location: "Nashville, TN",
    description: "Volunteer-powered freeform community radio.",
    streamUrl: "https://ice23.securenetsystems.net/WRFNLP",
    website: "https://radiofreenashville.org",
    coordinates: { lat: 36.1627, lng: -86.7816 },
    disableNowPlaying: true,
  },
  {
    ...
    frequency: "94.7 FM",
    location: "Concord, NH",
    description: "Community radio for the Concord area.",
    streamUrl: "https://seahorse.juststreamwith.us:8008/stream",
    website: "https://www.wnhnfm.org",
  ...
  },
  {
    ...
    description: "Voice of the Wimberley Valley.",
  ...
  {
    callSign: "KOGR-LP",
    name: "Oak Grove Radio",
    frequency: "98.5 FM",
    location: "Minneapolis, KS",
    description: "Community radio for Minneapolis.",
  ...
  {
    callSign: "KCBP",
    name: "Modesto Peace/Life Center Radio",
    frequency: "95.5 FM",
    location: "Modesto, CA",
  ...
  },
  {
    ...
    frequency: "97.1 FM",
    location: "Louisville, KY",
    description: "Volunteer-powered arts and experimental radio.",
    streamUrl: "https://patmos.cdnstream.com/proxy/artfmin1/?mp=/stream",
    website: "https://artxfm.com",
    coordinates: { lat: 38.2527, lng: -85.7585 },
    disableNowPlaying: true,
  },
  {
    callSign: "KNCE",
    name: "True Taos Radio",
    frequency: "93.5 FM",
    location: "Taos, NM",
    description: "Independent, locally-owned community radio.",
    streamUrl: "https://shoutcast.brownrice.com:8002/stream",
    website: "https://truetaosradio.com",
  ...
  },
  {
    ...
    frequency: "91.7 FM",
    location: "Wailuku, HI",
    description: "Commercial-free independent radio from Maui.",
    streamUrl: "https://kmno.streamguys1.com/live",
    website: "https://manaoradio.com",
    coordinates: { lat: 20.8911, lng: -156.5047 },
    disableNowPlaying: true,
  },
  {
    callSign: "WTIP",
    ...
    description: "Community radio on the North Shore of Lake Superior.",
    streamUrl: "https://wtip.broadcasttool.stream/stream",
    website: "https://wtip.org",
    coordinates: { lat: 47.7509, lng: -90.3343 },
    disableNowPlaying: true,
  },
  {
    callSign: "WDVR",
    frequency: "89.7 FM",
    location: "Delaware Township, NJ",
    description: "All-volunteer community radio since 1980.",
    streamUrl: "https://listen.wdvrfm.org/main",
    website: "https://wdvrfm.org",
    coordinates: { lat: 40.3718, lng: -74.9512 },
  },
  {
    callSign: "KSER",
    frequency: "90.7 FM",
    location: "Everett, WA",
    description: "Volunteer-powered community radio.",
    streamUrl: "https://kser.streamguys1.com/live",
    website: "https://www.kser.org",
  ...
  },
  {
    ...
    frequency: "90.7 FM",
    location: "Phoenix, AZ",
    description: "Jazz, blues, and community voices for the Valley.",
    streamUrl: "https://krdp.streamguys1.com/jazz",
